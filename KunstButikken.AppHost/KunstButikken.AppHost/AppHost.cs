...
var services = new List<IResourceBuilder<IResourceWithEnvironment>> { composition.AuthGateway, composition.UserService, composition.ArtService, composition.AuctionService, composition.PaymentService, composition.AdminService };
