...
public sealed class KeycloakTokenClient(IHttpClientFactory httpClientFactory, IConfiguration configuration) : IKeycloakTokenClient
{
    ...
    public async Task<KeycloakTokenResponse?> ExchangeCodeAsync(string code, string redirectUri, CancellationToken cancellationToken = default)
    {
        var payload = new Dictionary<string, string>
        {
            ...
            ["client_id"] = _configuration["KEYCLOAK_CLIENT_ID"] ?? "kunstbutikken-frontend"
        };
