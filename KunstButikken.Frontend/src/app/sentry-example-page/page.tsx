    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://arvid-torbjrnsen.sentry.io/issues/?project=4504588713066498">Issues Page</a>.
