...
internal sealed class RabbitMqEventBus : IEventBus, IDisposable
{
    ...
    [SuppressMessage("Design", "CA1031:Do not catch general exception types", Justification = "Event processing must catch all exceptions to nack messages and avoid crashing the process")]
